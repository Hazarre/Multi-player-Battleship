...
class Game:
	...
	# this method should check if the input is of valid format for the game state
	...
	def broadcastBoards(self,player):
		if player==1:
			...
			print(np.where(self.p2Board==1,0,self.p2Board))
		else:
			print("P2 Board:")
			print(self.p2Board)
			print("hidden P1 Board:")
			print(np.where(self.p1Board == 1, 0, self.p1Board))
